package spring.app.market.config.database;
...
import spring.app.market.config.database.mybatis.DaoSupport;
...
public class MybatisConfig {
  ...
  SqlSessionFactoryBean sqlSessionFactoryBean_primary() throws Exception {
    ...
    sqlSessionFactoryBean.setPlugins(new spring.app.market.config.database.mybatis.PagingInterceptor());
