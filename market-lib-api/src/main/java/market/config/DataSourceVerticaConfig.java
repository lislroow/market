...
@ConditionalOnProperty(
    prefix = "market.datasource."+Constant.DBMS.VERTICA + ".hikari", name = Constant.ENABLED,
    havingValue = "true",
...
public class DataSourceVerticaConfig {
  ...
  @ConfigurationProperties(prefix = "market.datasource."+Constant.DBMS.VERTICA+".hikari")
  ...
  @ConditionalOnProperty(name = "market.datasource." + Constant.DBMS.VERTICA + ".init", havingValue = "true", matchIfMissing = false)
